...
CODES: dict[str, str] = {
    ...
    "invalid_width": ERROR,
    "bore_smaller_than_tool": ERROR,
    "bore_outside_stock": ERROR,
    "slot_narrower_than_tool": ERROR,
    "slot_endpoints_coincide": ERROR,
    "slot_outside_stock": ERROR,
    "chamfer_needs_chamfer_mill": ERROR,
    "chamfer_too_wide": ERROR,
    "chamfer_too_deep": ERROR,
    # --- compiler ---------------------------------------------------------
    "no_operations": ERROR,
    "cancelled": ERROR,
    "missing_tool": ERROR,
